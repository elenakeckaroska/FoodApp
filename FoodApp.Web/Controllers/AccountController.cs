...
namespace FoodApp.Web.Controllers
{
    ...
    {
        private readonly UserManager<FoodAppUser> userManager;
        private readonly SignInManager<FoodAppUser> signInManager;
        private readonly RoleManager<IdentityRole> roleManager;
        public AccountController(UserManager<FoodAppUser> userManager, SignInManager<FoodAppUser> signInManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        public async Task<IActionResult> AddUserToRole(AddToRoleModel model)
        {
            ...
            FoodAppUser user = await userManager.FindByEmailAsync(email);
